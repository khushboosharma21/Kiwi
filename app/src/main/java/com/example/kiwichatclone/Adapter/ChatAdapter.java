package com.example.kiwichatclone.Adapter;
...
import com.example.kiwichatclone.R;
...
public class ChatAdapter extends RecyclerView.Adapter {
    ArrayList<MessageMdel>messageModels;
    Context context;
    String recId;
    int SENDER_VIEW_TYPE = 1;
    int RECIEVER_VIEW_TYPE = 2;

    public ChatAdapter(ArrayList<MessageMdel> messageMdels, Context context) {
        this.messageModels = messageMdels;
        this.context = context;
    }

    public ChatAdapter(ArrayList<MessageMdel> messageModels, Context context, String recId) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        MessageMdel messageModel  = messageModels.get(position);
